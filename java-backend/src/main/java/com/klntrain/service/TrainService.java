...
public class TrainService {
    ...
    public List<Map<String, Object>> searchTrains(Long idGaDi, Long idGaDen, String ngayChay) {
        String sql = """
    ...
    public Map<String, Object> getSeatMap(Long idChuyen, Integer soToa, Long idGaLen, Long idGaXuong) {
        // Lấy danh sách ghế đã bán (active) trong đoạn ga lên/xuống
        ...
        ToaChuyen toa = toaChuyenRepo.findByIdChuyenAndSoToaThuTu(idChuyen, soToa)
            .orElseThrow(() -> AppException.notFound("Không tìm thấy toa " + soToa));
