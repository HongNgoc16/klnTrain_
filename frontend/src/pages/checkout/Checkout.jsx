...
const Checkout = () => {
  ...
  const { trips, totalPassengers, adultTickets = 1, childTickets = 0, tripType, hetHan } = state || {}
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-5">
                ...
                {passengers.map((passenger, idx) => {
                  // isChild được xác định từ seat data (sequential), không dùng global adultTickets
                  const seatInfo  = allSeats[idx]
                  const isChild   = seatInfo?.isChild ?? (idx >= adultTickets)
