...
import { isExchangeable, calculateExchangeFee } from '../../../data/bookingMock'
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {booking.trips?.map(trip => {
        const eligible = isExchangeable(trip.departDate, trip.departTime)
        return (
          <div key={trip.tripId} className="bg-white rounded-lg shadow-md p-5 mb-4">
            ...
            <div className="space-y-3">
              {trip.passengers?.map(p => {
                ...
                const fee = calculateExchangeFee(p.price)
                return (
                  <label key={p.id}
